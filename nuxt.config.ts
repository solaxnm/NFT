export default defineNuxtConfig({
  ...
  app: {
    head: {
      title: 'Learn NFT by SolanaM - NFT Education Hub',
      meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { name: 'description', content: 'Master NFTs with SolanaM comprehensive education hub. Learn blockchain development, smart contracts, trading, and create NFTs on high-performance, low-cost networks.' },
        ...
        { name: 'google-site-verification', content: 'your-google-verification-code' }, // Replace with actual code
      ],
      link: [
        ...
        // Added for SEO
        { rel: 'alternate', type: 'application/rss+xml', title: 'NFT Learn RSS Feed', href: 'https://nft.solanam.com/rss.xml' }
      ],
      script: [
        // Structured data for SEO
        {
          ...
          innerHTML: JSON.stringify({
            ...
            '@type': 'WebSite',
            'url': 'https://nft.solanam.com',
            'name': 'NFT Learn by SolanaM',
            'description': 'Comprehensive NFT education platform by SolanaM',
            'potentialAction': {
              '@type': 'SearchAction',
              'target': 'https://nft.solanam.com/search?q={search_term_string}',
